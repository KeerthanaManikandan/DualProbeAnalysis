# Read Me
This repository contains all codes necessary to process and store RS data collected from two linear electrode arrays simultaneously. Data are publicly available on the DANDI Archive (RRID:SCR_017571) at the following URL: https://dandiarchive.org/dandiset/001881

## Main scripts
1. `combinedAnalysisEphysDualProbeRS_vFinal.m`: Combines the pairwise correlations from two animals and generates the necessary figures
